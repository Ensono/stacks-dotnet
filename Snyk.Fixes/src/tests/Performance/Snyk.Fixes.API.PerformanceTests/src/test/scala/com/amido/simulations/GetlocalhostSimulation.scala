...
import com.amido.scenarios.GetlocalhostScenario
...
class GetlocalhostSimulation extends Simulation {
  private val getlocalhostRampExec = GetlocalhostScenario.getlocalhostScenario
    .inject(
