...
namespace Snyk.Fixes.API.FunctionalTests.Tests.Stories
{
    ...
    [Story(
        ...
        IWant = "to be able to create localhosts with categories and items",
    ...
    public class CreateItemTests : IClassFixture<AuthFixture>
    {
        ...
        [Fact]
        public void Create_item_for_localhost()
        {
            this.Given(step => fixture.GivenAUser())
                .And(step => itemSteps.GivenIHaveSpecfiedAFullItem())
                .When(step => itemSteps.WhenICreateTheItemForAnExistinglocalhostAndCategory())
