...
using Shouldly;
using Xunit;
using Snyk.Fixes.Common.Events;
...
namespace Snyk.Fixes.CQRS.UnitTests
{
    ...
    public class EventsTests
    {
        ...
        {
            var assembly = typeof(localhostCreated).Assembly;
        ...
        {
            var definitions = typeof(localhostCreated).Assembly.GetImplementationsOf(typeof(IApplicationEvent));
