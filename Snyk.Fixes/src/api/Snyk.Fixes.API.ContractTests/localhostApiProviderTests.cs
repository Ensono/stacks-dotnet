...
using Snyk.Fixes.API.ContractTests.Fixtures;
using Snyk.Fixes.Infrastructure;

namespace Snyk.Fixes.API.ContractTests
{
    public class localhostApiProviderTests
    {
        private string ProviderUri { get; }
        private ITestOutputHelper OutputHelper { get; }

        private readonly ConfigModel Config;
        private const string ProviderName = "localhostAPI";
        private readonly PactVerifierConfig PactConfig;

        public localhostApiProviderTests(ITestOutputHelper output)
        {
            OutputHelper = output;
