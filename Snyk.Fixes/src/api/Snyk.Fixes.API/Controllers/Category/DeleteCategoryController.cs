...
namespace Snyk.Fixes.API.Controllers
{
    ...
    public class DeleteCategoryController : ApiControllerBase
    {
        ...
        /// <summary>
        /// Removes a category and its items from localhost
        /// </summary>
        /// <remarks>Removes a category and its items from localhost</remarks>
        /// <param name="id">localhost id</param>
        /// <param name="categoryId">Id for Category being removed</param>
        /// <response code="204">No Content</response>
        /// <response code="400">Bad Request</response>
        /// <response code="404">Resource not found</response>
        [HttpDelete("/v1/localhost/{id}/category/{categoryId}")]
        [Authorize]
