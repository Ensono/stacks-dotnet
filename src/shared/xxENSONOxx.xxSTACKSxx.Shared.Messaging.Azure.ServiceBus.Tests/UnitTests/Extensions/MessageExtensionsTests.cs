...
namespace xxENSONOxx.xxSTACKSxx.Shared.Messaging.Azure.ServiceBus.Tests.UnitTests.Extensions
{
    public class MessageExtensionsTests
    {
        ...
        public void MessageExtensionSetEnclosedMessageType()
        {
            ...
            message.UserProperties["EnclosedMessageType"].ShouldBe("xxENSONOxx.xxSTACKSxx.Shared.Messaging.Commands.NotifyCommand, xxENSONOxx.xxSTACKSxx.Shared.Messaging.Commands");
        }
