...
public class Startup(IWebHostEnvironment env, IConfiguration configuration, ILogger<Startup> logger)
{
    ...
    private readonly string pathBase = Environment.GetEnvironmentVariable(Constants.EnvironmentVariables.ApiBasePathEnvName) ??
                                       String.Empty;
    private readonly bool useAppInsights = !string.IsNullOrEmpty(
