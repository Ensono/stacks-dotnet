...
module "app" {
  ...
  dns_zone_resource_group              = try(data.terraform_remote_state.core.outputs.dns_resource_group_name, try(data.terraform_remote_state.core.outputs.resource_group_name, "stacks-ancillary-resources"))
