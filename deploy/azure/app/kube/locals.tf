locals {
  ...
  eventhub_connection_string  = local.lookup_eventhub ? data.azurerm_eventhub_namespace.eventhub_namespace[0].default_primary_connection_string : module.eventhub[0].eventhub_connectionstring
  eventhub_name               = local.lookup_eventhub ? var.eventhub_name : module.eventhub[0].eventhub_name
  eventhub_storage_access_key = local.lookup_eventhub ? data.azurerm_storage_account.eventhub_storage_account[0].primary_access_key : module.eventhub[0].eventhub_sa_connectionstring
