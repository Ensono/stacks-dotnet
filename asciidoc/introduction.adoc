...
TIP: **Demo**
For a clearer understanding of the output, there is a demo API hosted link:https://dev-netcore-api.nonprod.ensonostacks.com/api/menu/swagger/index.html[here].
