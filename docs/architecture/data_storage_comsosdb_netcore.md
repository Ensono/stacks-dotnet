...
id: data\_storage\_cosmosdb\_netcore
...
The focus of this guide is the CosmosDB SQL API, and it assumes that the reader has prior knowledge about [CosmosDB SQL API](https://docs.microsoft.com/en-us/azure/cosmos-db/sql-query-getting-started) in order to understand the concepts described thereafter.
